...
def test_kimi_platform_selection_keeps_endpoint_configuration_consistent():
    """Переключение площадки Kimi обязано синхронизировать Base URL, а править адрес разрешено только в режиме «своё значение»."""
    app_config = dict(
        config.app,
    ...
    with (
        ...
        # Китайская площадка — совместимое значение по умолчанию из Registry, дублировать его в конфигурации пользователя не нужно.
